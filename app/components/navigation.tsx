...
type MenuItem = {
  ...
  | { type?: "link"; href: string; subItems?: MenuItem[] }
...
const menuItems: NavigationCategory[] = [
  {
    ...
    items: [
      ...
      {
        type: "link",
        name: "JAPAN WORLD HEAD QUARTER",
        href: "/about/japanheadq",
      },
      {
        type: "link",
        name: "INDIA NATIONAL HEAD QUARTER",
        href: "/about/indianheadq",
      },
        ...
        subItems: [
          {
            ...
            href: "/commission/refree",
          },
          {
            type: "link",
            name: "SPORTS COMMISSION",
            href: "/commission/sports",
          },
          {
            type: "link",
            name: "TECHNICAL & COMMUNICATION COMMISSION",
            href: "/commission/technical&Communication",
          },
          {
            type: "link",
            name: "TOURNAMENT COMMISSION",
            href: "/commission/tournament",
          },
  ...
  },
  {
    ...
    items: [
      {
        type: "link",
        name: "JAPAN BLACK BELT",
        href: "/black-belt-holders/japan-blackbelt",
      },
      {
        type: "link",
        name: "INDIA BLACK BELT",
        href: "/black-belt-holders/indian-blackbelt",
      },
          ...
          <nav className="hidden lg:block">
            <ul className="flex space-x-8">
              <li>
                <Link
                  href="/"
                  className="text-md text-white hover:text-yellow-400 transition-colors"
                >
                  HOME
                </Link>
              </li>
