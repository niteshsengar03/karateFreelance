...
import { japanBlackBeltHolders } from "@/app/data/blackBeltHolders"
import { Search, ChevronLeft, ChevronRight } from "lucide-react"

const categories = ["All", "1st Dan", "2nd Dan", "3rd Dan", "4th Dan", "5th Dan", "6th Dan"]
...
export default function BlackBeltHoldersPage() {
  ...
  const filteredBelts = useMemo(() => {
    return japanBlackBeltHolders.filter((belt) => {
